<div id="dashboard-wrap" class="bodycontent">
	...
	<section id="dashboard-panel" class="text-center">
		<ul class="row" data-equalizer>
			...
			<li class="small-6 medium-4 columns admin-nav" data-equalizer-watch><i class="fa fa-cog"></i><br><a href="<?php echo base_url() . index_page(); ?>resources/add">Add</a> / <a href="<?php echo base_url() . index_page(); ?>resources/edit">Edit</a><p class="dashboard-desc">Add, Edit or Delete resources</p></li>
		</ul>
	</section>
