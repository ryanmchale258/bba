<div id="dashboard-wrap" class="bodycontent">
	...
	<section id="dashboard-panel" class="text-center">
		<ul class="row" data-equalizer>
			...
			<li class="small-6 medium-4 columns admin-nav" data-equalizer-watch><i class="fa fa-users"></i><br><a href="<?php echo base_url() . index_page(); ?>admin/add">Add</a> / <a href="<?php echo base_url() . index_page(); ?>admin/edit">Edit</a><br><p class="dashboard-desc">Add, Edit or Delete users for the admin system</p></li>
			<li class="small-6 medium-4 columns admin-nav" data-equalizer-watch><i class="fa fa-user-plus"></i><br><a href="<?php echo base_url() . index_page(); ?>staff/add">Add</a> / <a href="<?php echo base_url() . index_page(); ?>staff/edit">Edit</a><br><p class="dashboard-desc">Add, Edit or Delete staff profiles</p></li>
			...
			<li class="small-6 medium-4 columns admin-nav" data-equalizer-watch><i class="fa fa-envelope"></i><br><a href="<?php echo base_url() . index_page(); ?>resources/add">Add</a> / <a href="<?php echo base_url() . index_page(); ?>resources/edit">Edit</a><p class="dashboard-desc">Add, Edit or Delete resources</p></li>
		</ul>
	</section>
