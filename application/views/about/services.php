	...
	<section class="about row" data-equalizer>
		...
		<article class="services small-12 medium-6 columns" data-equalizer-watch>
			...
			<ul>
				...
				<li>Nutrition care planning</li>
				<li>Clinical nutrition interventions including, but not limited to:
					<ul>
						<li>Diabetes management</li>
						<li>Dysphagia management</li>
						<li>Nutrition in wound care management</li>
		...
		<article class="services small-12 medium-6 columns" data-equalizer-watch>
			...
			<ul>
				...
				<li>Participation in accreditation processes</li>
		...
		<article class="services small-12 medium-6 columns" data-equalizer-watch>
			...
			<ul>
				...
				<li>Interpretation of Ministry Regulations and Inspection Protocols</li>
				<li>Program audit and evaluation</li>
				<li>QM policies/procedures</li>
				<li>Nutrition care services audits</li>
				<li>Peer reviews</li>
			</ul>
		</article>
		<article class="services small-12 medium-6 columns" data-equalizer-watch>
			...
			<ul>
				...
				<li>Qualified teachers for food service worker training program</li>
				<li>Clinical and administrative policies/procedures</li>
				<li>Algorithms/protocols for the care team</li>
				<li>RAI-MDS tools and resources</li>
